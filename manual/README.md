...
```
기본적으로 Hexagonal Architecture는 위와 같이 최대 4의 구성을 가짐
...
그런데 여기서는 도 약간의 차이가 있는데 바로 Spring Boot를 사용하면 
...
기존 Layerd 구성에서는 이 코드를 작성하기가 상당히 난감했음.
어디에 배치하는 것이 가장 좋을까?
